...
# ---------- CARGAR DATOS ----------
with open("data/processed_data_2.pkl", "rb") as f:
    data = pickle.load(f)
...
cant_features = X_train.shape[1]       # cantidad de features (13)
cant_genre = y_train.shape[1]      # cantidad de generos (18)

model = Sequential([
    Dense(256, activation='relu', input_shape=(cant_features,)),
    Dropout(0.3),
